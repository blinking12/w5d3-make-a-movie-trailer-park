...
//Person name and height
//Athlete collegeGrad teamName
//Baseball Player  battingAvg hangPref
...
class Athlete extends Person {
    constructor(collegeGrad, teamName) {
        super('Troy', '6\'0')
...
var jeff = new Athlete('2016', 'Indians')
jeff.howFast('4.3')
// console.log(jeff)

class BaseballPlayer extends Athlete {
    constructor(battingAvg, handPref) {
        super('2016', 'Indians')
        this.battingAvg = battingAvg
        this.handPref = handPref
    }
}
var guyname = new BaseballPlayer('2', 'mostly right')
console.log(guy)
